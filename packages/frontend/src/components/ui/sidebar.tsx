...
type SidebarContext = {
  ...
  setNavBody: (body: React.ReactNode) => void;
};
...
>(
  (
    ...
    const [navBody, setNavBody] = React.useState<React.ReactNode | null>(null);
...
interface SidebarGroupProps extends React.ComponentProps<"div"> {
  collapse_hide?: boolean;
}
const SidebarGroup = React.forwardRef<HTMLDivElement, SidebarGroupProps>(
  ({ className, collapse_hide, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="group"
        className={cn(
          ...
          collapse_hide
            ? "group-data-[collapsible=icon]:hidden [&_*]:text-xs"
            : null,
          className,
        )}
        {...props}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        "[&_*]:font-medium [&_*]:text-muted-foreground",
        className,
      )}
      {...props}
    />
